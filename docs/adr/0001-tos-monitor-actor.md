...
American Electric Power Company, Inc. (AEP), per ADR-2607110300 -- a
read-only reference archive. As part of a third 10-repo validation batch
extending the `cloud-itonami-lei-2572ibtt8cczw6au4141` pilot (see
ADR-2607241900/ADR-2607242400 for the full fleet-level design rationale),
...
- **Company**: American Electric Power Company, Inc., LEI
  1B4S6S7G0TW5EE83BO58, website `https://www.aep.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.aep.com/terms/`,
