(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (American Electric Power Company,
  Inc., LEI 1B4S6S7G0TW5EE83BO58) -- unlike `commitledger.store`'s
...
(def ^:private demo-full-text
  "Terms & Conditions\nUse of this site constitutes acceptance of these Terms and Conditions published by American Electric Power Company, Inc. (AEP). The content of this site is provided for informational purposes only and is subject to change without notice. These Terms are governed by the laws of the State of Ohio.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.aep.com/terms/"
